...
--14
SELECT COUNT (StaffNo) AS 'Total Manager'
FROM Staff
WHERE position ='Manager'


--15
SELECT MIN (salary) AS 'Min Salary', MAX(salary), AVG(salary) AS 'Average Salary'
FROM Staff

--16
SELECT COUNT (staffNo) AS 'Total Staff', SUM(salary) AS 'Total Salary'
FROM Staff
